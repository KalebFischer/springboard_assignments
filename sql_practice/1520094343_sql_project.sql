...
SELECT facilities.name AS "Court",
    ...
    " ",
    members.surname) AS "member name"
...
GROUP BY CONCAT(members.firstname,
    " ",
    members.surname)
ORDER BY CONCAT(members.firstname,
    " ",
    members.surname)
...
SELECT CONCAT(members.firstname,
    	   " ",
...
FROM(
    SELECT facility, SUM(sub1.cost) AS total_revenue
    FROM(
